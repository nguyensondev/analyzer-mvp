...
const etherscanService = require('../real/etherscan.service');
const bscscanService = etherscanService;
const solscanService = etherscanService;
const covalentService = etherscanService;

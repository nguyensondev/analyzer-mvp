const twitterAPI = require('./twitter-api.service');
...
class SocialEnhancedService {
  ...
  aggregateRealData(ticker, twitter, reddit, github, marketCap) {
    ...
    const communityScore = this.calculateCommunityScore(twitter, reddit);
    const engagementScore = this.calculateEngagementScore(twitter, reddit);
    const developerScore = this.calculateDeveloperScore(github);
